...
if choice1 == 1:
    model1, gc1 = MKBwz(x1)
    model2, gc = MKPower(x2,order=3)
    model3, gc3 = MKLegendre(x1,order=[1,2,3,4])
    model4, gc4 = MKExp2(x1)
    model5, gc5 = MKBernstein(x,order=4)
else:
    model1, gc1 = MKBwz(x1)
