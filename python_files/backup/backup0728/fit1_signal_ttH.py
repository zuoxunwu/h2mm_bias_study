...
elif choice1 == 2: # chi2 = 0.277
    h = f.Get("H_pair_mass_BDT_v1_tight_noBDT_n10_n02_zoomH_Net_Sig")
elif choice1 == 3: # 1.2
    h = f.Get("H_pair_mass_BDT_v1_tight_noBDT_p02_p10_zoomH_Net_Sig")
elif choice1 == 4: # 1.2
    h = f.Get("H_pair_mass_BDT_v1_tight_noBDT_p02_p10_zoomH_Net_Sig")
...
def MKTripleGauss(x):
    ...
    meanG1 = r.RooRealVar("MeanG1", "MeanG1", 125, 120, 130)
    meanG2 = r.RooRealVar("MeanG2", "MeanG2", 130, 110, 130)
    ...
    coefG1 = r.RooRealVar("coefG1",  "coefG1", 0.5,0.5,1.)
